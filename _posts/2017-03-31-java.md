...
public final class System {
 ...
   * @param      src      源数组.
   * @param      srcPos   源数组中的起始位置, 若 srcPos+length 大于 src.length，即源数组的长度, 则抛出 IndexOutOfBoundsException 异常
   * @param      dest     目标数组.
   * @param      destPos  目标数组中的起始位置, 若 destPos+length 大于 dest.length，即目标数组的长度, 则抛出 IndexOutOfBoundsException 异常
